     ...
     <div id="container" style="margin-left: 0px;margin-right: 0px;">
        ...
        <div id='videoLocalBord2'>
           ...
           <div id='buttonsLocal2'>
               <button class="btn btn-outline-dark button-style button-wide" onclick="getLocalVideo().play()" id="playLocal2">再生</button>
               <button class="btn btn-outline-dark button-style button-wide" onclick="getLocalVideo().pause()" id="pauseLocal2">停止</button><br>
     ...
     <div class="modal fade" id="saveModal" tabindex="-1" role="dialog" aria-labelledby="saveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <form id="save-form" method="POST" action="{{ route('youlocal.store') }}">
                <div class="modal-body">
                    ...
                    <div class="form-group row" style="display:none;">
                        ...
                        <div class="col-md-10">
                            <input id="video_type" type="text" class="form-control" name="video_type" value="3" autocomplete="off" autofocus>
                        </div>
                    </div>
                </div>
