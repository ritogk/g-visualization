...
/***/ "./resources/ts/libs/trigonometric.ts":
/*!********************************************!*\
  !*** ./resources/ts/libs/trigonometric.ts ***!
  \********************************************/
...
/* harmony export */ });
/* harmony import */ var _libs_trigonometric__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/libs/trigonometric */ "./resources/ts/libs/trigonometric.ts");
/**
 * 三次元ベクトルの回転処理
 * ※worker用
 */
...
w.onmessage = function (event) {
  var data = event.data;
  var rotate_acceration = (0,_libs_trigonometric__WEBPACK_IMPORTED_MODULE_0__.rotate3dVector)(data.x, data.y, data.z, data.angle_x, data.angle_y, data.angle_z);
