...
/***/ "./resources/ts/views/GAnalys/services/trigonometric.ts":
/*!**************************************************************!*\
  !*** ./resources/ts/views/GAnalys/services/trigonometric.ts ***!
  \**************************************************************/
...
(() => {
/*!***********************************************************!*\
  !*** ./resources/ts/views/GAnalys/worker/vectorRotate.ts ***!
  \***********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _views_GAnalys_services_trigonometric__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/views/GAnalys/services/trigonometric */ "./resources/ts/views/GAnalys/services/trigonometric.ts");
/**
 * 三次元ベクトルの回転処理
 * ※worker用
 */
...
w.onmessage = function (event) {
  var data = event.data;
  var rotate_acceration = (0,_views_GAnalys_services_trigonometric__WEBPACK_IMPORTED_MODULE_0__.rotate3dVector)(data.x, data.y, data.z, data.angle_x, data.angle_y, data.angle_z);
